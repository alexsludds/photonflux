...
def _LaserRate_setup(Rs: float=5.0, Nscl: float=0.0, Sscl: float=0.0, vg: float=75000000.0, a0: float=2.5e-20, Va: float=1e-16, taun: float=0.0, Gam: float=0.3, taup: float=0.0, beta: float=0.0001, Csc: float=0.0, eta0: float=0.4, Eph: float=1.516e-19, Von: float=1.2, Ntr: float=1e+24, eps: float=1.5e-23, etai: float=0.8, _mfactor: float=1.0) -> jnp.ndarray:
    i_v55 = _mfactor * -Csc
    i_v54 = 0.0 - Csc
...
def _LaserRate_combined(signals: Signals, s: States, init, Rs: float=5.0, Nscl: float=0.0, Sscl: float=0.0, vg: float=75000000.0, a0: float=2.5e-20, Va: float=1e-16, taun: float=0.0, Gam: float=0.3, taup: float=0.0, beta: float=0.0001, Csc: float=0.0, eta0: float=0.4, Eph: float=1.516e-19, Von: float=1.2, Ntr: float=1e+24, eps: float=1.5e-23, etai: float=0.8, _mfactor: float=1.0) -> tuple:
...
def _LaserRate_jacobian(signals: Signals, s: States, init, Rs: float=5.0, Nscl: float=0.0, Sscl: float=0.0, vg: float=75000000.0, a0: float=2.5e-20, Va: float=1e-16, taun: float=0.0, Gam: float=0.3, taup: float=0.0, beta: float=0.0001, Csc: float=0.0, eta0: float=0.4, Eph: float=1.516e-19, Von: float=1.2, Ntr: float=1e+24, eps: float=1.5e-23, etai: float=0.8, _mfactor: float=1.0) -> tuple:
...
def LaserRate(signals: Signals, s: States, init, Rs: float=5.0, Nscl: float=0.0, Sscl: float=0.0, vg: float=75000000.0, a0: float=2.5e-20, Va: float=1e-16, taun: float=0.0, Gam: float=0.3, taup: float=0.0, beta: float=0.0001, Csc: float=0.0, eta0: float=0.4, Eph: float=1.516e-19, Von: float=1.2, Ntr: float=1e+24, eps: float=1.5e-23, etai: float=0.8, _mfactor: float=1.0) -> PhysicsReturn:
