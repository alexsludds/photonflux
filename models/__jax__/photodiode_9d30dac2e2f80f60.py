...
def _Photodiode_setup(R: float=0.8, Cj: float=0.0, Idk: float=0.0, _mfactor: float=1.0) -> jnp.ndarray:
    i_v20 = _mfactor * R
    i_v23 = _mfactor * Cj
    i_v25 = _mfactor * -R
    i_v27 = _mfactor * -Cj
...
def _Photodiode_combined(signals: Signals, s: States, init, R: float=0.8, Cj: float=0.0, Idk: float=0.0, _mfactor: float=1.0) -> tuple:
...
def _Photodiode_jacobian(signals: Signals, s: States, init, R: float=0.8, Cj: float=0.0, Idk: float=0.0, _mfactor: float=1.0) -> tuple:
...
def Photodiode(signals: Signals, s: States, init, R: float=0.8, Cj: float=0.0, Idk: float=0.0, _mfactor: float=1.0) -> PhysicsReturn:
