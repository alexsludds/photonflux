...
def _LaserDml_setup(Rs: float=5.0, tau: float=5e-11, Von: float=1.2, slope: float=0.3, Ith: float=0.01, _mfactor: float=1.0) -> jnp.ndarray:
    i_v21 = _mfactor * -1.0
    i_v19 = -tau
    return jnp.array([i_v21, i_v19])

def _LaserDml_combined(signals: Signals, s: States, init, Rs: float=5.0, tau: float=5e-11, Von: float=1.2, slope: float=0.3, Ith: float=0.01, _mfactor: float=1.0) -> tuple:
...
def _LaserDml_jacobian(signals: Signals, s: States, init, Rs: float=5.0, tau: float=5e-11, Von: float=1.2, slope: float=0.3, Ith: float=0.01, _mfactor: float=1.0) -> tuple:
...
def LaserDml(signals: Signals, s: States, init, Rs: float=5.0, tau: float=5e-11, Von: float=1.2, slope: float=0.3, Ith: float=0.01, _mfactor: float=1.0) -> PhysicsReturn:
